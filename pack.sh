...
rm gts.zip ; zip -ry9 gts.zip db dbd tmp/S56StartNumexo2; zip -j gts.zip gts.sh bin/linux-ppc/gts envGTSid gtsApp/src/envGTS_ID iocBoot/iocgts/gts.cmd bin/linux-ppc/caRepeater
