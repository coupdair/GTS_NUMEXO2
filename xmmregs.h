...
extern int  XMMRegs_MuxInOut_ExternalRxMux_Set(XMMRegs *InstancePtr, int transceiver, int mgt_sfp);
extern int  XMMRegs_MuxInOut_ExternalTxMux_Set(XMMRegs *InstancePtr, int transceiver, int mgt_sfp);
...
/*  RocketIO APIs                           */
/***********************************************/
extern int  XMMRegs_RocketIO_Setup(XMMRegs *InstancePtr);
extern int  XMMRegs_RocketIO_Start(XMMRegs *InstancePtr);
extern int  XMMRegs_RocketIO_Stop(XMMRegs *InstancePtr);
extern int  XMMRegs_RocketIO_Init(XMMRegs *InstancePtr);
...
extern int  XMMRegs_DataPath_AllTxmux_Set(XMMRegs *InstancePtr, int val);
extern int  XMMRegs_DataPath_AllRxmux_Set(XMMRegs *InstancePtr, int val);
...
extern int  XMMRegs_Trigger_GtsReady_Set(XMMRegs *InstancePtr);
extern int  XMMRegs_Trigger_GtsReady_UnSet(XMMRegs *InstancePtr);
